...
- A listing that has stopped keeps its entry (people search for it) and gets a
  ...
  the listing is never offered under "this weekend". Clear `status` when it restarts.
