...
(function () {
  var m = HS.qs().get("m") || "";
  var copy = {
    subscribed: ["You're subscribed", "You're confirmed. Your first update arrives on the next scheduled morning. Every email carries a one-click unsubscribe link and every WhatsApp update an Unsubscribe button.", [["events.html", "See what's on now"], ["subscribe.html", "Change your choices"]]],
